...
# I didn't like default terminal output
...
pca_scores = cross_val_score(
    pca_pipeline, X_train, y_train, cv=5, scoring="accuracy")
print("\nPCA Model (2 Components):")
print(
    f"Cross-validated Accuracy: {pca_scores.mean():.2f} ± {pca_scores.std():.2f}\n")
